...
Purpose
-------
Sets up a single node instance of Cassandra

Execute Playbook
----------------
<pre>$ ansible-playbook --private-key=/Users/z001hqv/Vagrant/cassandra/.vagrant/machines/default/virtualbox/private_key -u vagrant -i inventory playbook.yml</pre>
...
in the metadata file. Without Ansible 2.0 or higher, you will experience an error
when running the configure task in the Cassandra role.
